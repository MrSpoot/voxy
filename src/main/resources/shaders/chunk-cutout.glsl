...
void main() {
    ...
    float textureLayer = float(vTextureIndex * 6) + faceSlot;
    ...
    if (uDebugLightVisualizationEnabled != 0) {
        ...
        fragColor = vec4(getDebugAbsoluteLightColor(getPackedLight(vLightOffset, sampleCoords.x, sampleCoords.y, sampleCoords.z)), texel.a);
        return;
    }
